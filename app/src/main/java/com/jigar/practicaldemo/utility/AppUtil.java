package com.jigar.practicaldemo.utility;
...
//            mProgressDialog.addContentView(DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.layout_custom_loader, null, false).getRoot(), null);
